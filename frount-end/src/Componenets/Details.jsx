...
function Details() {
  ...
  useEffect(()=>{
    if(user){
      axios.post(`https://cipher-gne4.onrender.com/info/details/${user._id}`)
      .then((r)=>{
        console.log(r);
      })
      .catch((e)=>{
    ...
    if(user){
      axios.get(`https://cipher-gne4.onrender.com/profile/${user._id}`)
      .then((r)=>{
        console.log(r);
      })
      .catch((e)=>{
